"""
Django settings for my_loginform project.
...
SECRET_KEY = 'django-insecure-5pu-s7st#ek593jy5%_mnj43g(bh_!4gq+&xp+@usjp^_p(&i@'
...
ROOT_URLCONF = 'my_loginform.urls'
...
WSGI_APPLICATION = 'my_loginform.wsgi.application'
